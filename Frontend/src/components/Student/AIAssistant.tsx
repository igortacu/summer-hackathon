...
const AIAssistant = () => {
    ...
    const handleSendMessage = async (e: React.FormEvent) => {
        ...
        try {
            // This now points to your specific endpoint on the correct port
            const response = await fetch('http://localhost:5500/chatbot', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                // This sends the data in the format your Python code expects: {"message": "..."}
            ...
            // This expects the JSON from Python to have an "answer" key
